...
!> This sample code will create a file on the SD card and will write the word "This text was written from the ATMegaZero board!". Please make sure to insert an SD card before running the code. 

![ATMegaZero](./media/sd_card_thumbnail.jpg)
